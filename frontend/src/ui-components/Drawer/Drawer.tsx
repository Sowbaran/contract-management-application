                    ...
                    {enableDefaultClose && (
                      <div className={defaultCloseBtnSty}>
                        <button
                          ...
                          className="cursor-pointer relative z-20 -left-3 p-1 rounded-full bg-white  text-slate-500  focus:outline-none shadow-xl ring-1 ring-slate-100"
                        >
                          <ChevronRightIcon
                            aria-hidden="true"
                            className="h-5 w-5"
