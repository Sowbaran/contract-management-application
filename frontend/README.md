...
```
git clone https://github.com/nrldigitaltechnology/nrl-boilerplate-frontend
```

Changing into the new directory

```
cd nrl-boilerplate-frontend
```
...
This repo uses plop to generate components via cli

Run `npm run generate` you will be prompted to enter a component name. After entering this, plop will create all required files including storybook and unit test file.

Files are created at `src/components/{{NAME}}`
